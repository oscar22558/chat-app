    ...
    public SecurityFilterChain filterChain(HttpSecurity http, JWTAuthFilter jwtAuthFilter) throws Exception {
        http
                ...
                .authorizeHttpRequests((authz) -> authz
                        ...
                        .requestMatchers(antMatcher("/api/greeting")).permitAll()
                        .requestMatchers(antMatcher("/api/greeting1")).permitAll()
                        .requestMatchers(antMatcher("/api/**")).authenticated()
                        .requestMatchers(antMatcher("/api/group/**/member/**")).hasRole("USER")
                        .requestMatchers(antMatcher("/api/group/invitation/**")).hasRole("USER")
